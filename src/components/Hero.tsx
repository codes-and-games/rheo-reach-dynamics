...
export const Hero = () => {
  ...
  variant="hero" 
  size="xl"
  className="group fixed bottom-6 right-6 z-50 shadow-lg"
...
>
  ...
  <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
      ...
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-500/20 rounded-full blur-[120px] animate-float" style={{ animationDelay: "1s" }} />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center space-y-8 animate-fade-in-up">
          ...
          <div className="inline-flex items-center gap-2 glass-card px-4 py-2 rounded-full text-sm animate-scale-in">
            ...
            <span className="text-muted-foreground">Digital Solutions at your thumbprints</span>
          </div>
